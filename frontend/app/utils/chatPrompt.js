/**
 * Shared system prompt for Robert Cole's portfolio chat assistant.
 * This file serves as the single source of truth for the chat system prompt
 * used by both the Azure Function backend and the Next.js API route.
 */
